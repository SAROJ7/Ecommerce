            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-5">
                  Anonymous, Bagmati, Kathmandu <br /> Bagmati, Nepal <br />
                  PinCode:44800
                </address>
                <a
                  href="tel:+977 XXXXXXXXXX"
                  className="mt-4 d-block text-white mb-2"
                >
                  +977 XXXXXXXXXX
                </a>
                <a
                  href="mailto:xxxxx@xxxxxx.com"
                  className="mt-4 d-block text-white mb-2"
                >
                  xxxxx@xxxxxx.com
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by DevConn
              </p>
            </div>
          </div>
        </div>
